...
Future<List<AttendanceRecordModel>> getEmployeeAttendanceRecord() async {
  try {
    ...
    final url = Uri.parse(Urls.getEmployeeAttendanceRecordUrl)
    ...
    if (resp.statusCode == 200) {
      ...
      final response =
          decoded.map((item) => AttendanceRecordModel.fromJson(item)).toList();

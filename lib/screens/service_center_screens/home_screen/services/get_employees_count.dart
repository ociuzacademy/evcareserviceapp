...
Future<EmployeeCountModel> getEmployeesCount() async {
  try {
    ...
    final url =
        Uri.parse(Urls.getEmployeesCountUrl).replace(queryParameters: params);
    ...
    if (resp.statusCode == 200) {
      ...
      final response = EmployeeCountModel.fromJson(decoded);

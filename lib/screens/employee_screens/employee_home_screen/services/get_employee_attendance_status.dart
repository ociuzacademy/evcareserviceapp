...
Future<EmployeeAttendanceStatusModel> getEmployeeAttendanceStatus() async {
  try {
    ...
    final url = Uri.parse(Urls.getEmployeeAttendanceStatusUrl)
    ...
    if (resp.statusCode == 200) {
      ...
      final response = EmployeeAttendanceStatusModel.fromJson(decoded);
